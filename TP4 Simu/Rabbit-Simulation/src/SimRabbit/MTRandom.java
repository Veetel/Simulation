...
/**
 * -----------------------------------------------------------------------------------------------------------------------------------------
 * Serialization support. by @author : ELNASORY Karm 
 * -----------------------------------------------------------------------------------------------------------------------------------------
 */

  /**
   * Saves the state of the MTRandom generator to a file.
   *
  ...
  /**
   * Loads the state of the MTRandom generator from a file.
   *
   * @param filename The name of the file to load the state from.
   * @return The MTRandom instance with the loaded state.
   * @throws IOException If an I/O error occurs.
   * @throws ClassNotFoundException If the class of a serialized object cannot be found.
   */
  public static MTRandom loadState(String filename) throws IOException, ClassNotFoundException 
  {
    try (ObjectInputStream in = new ObjectInputStream( new FileInputStream ( filename ) ) ) 
    {
      return ( MTRandom ) in.readObject ();
    }
  }
